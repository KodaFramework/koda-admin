...
$.Class.extend("ExplorerPresenter", 
	{ panel: {}, kodaTypes:{}, controller: {}, isCtrl: false }, 
	{
		...
		editDialog : function(itemUrl, type, callback){
			...
			if(type=="collection"){
				self.launchEditor('/admin/koda/koda-editors/collection-editor.html', '', itemUrl, false, callback);
			} else {
				self.Class.controller.findCommand('get', function(cmd) {
					cmd.execute([itemUrl], function(result) {
						if('_koda_editor' in result) {
							...
							self.launchEditor('/admin/koda/koda-editors/json-editor.html', '', itemUrl, false, callback);
						}
					});
				});
			}
...
$.Class.extend("Explorer", {}, {
	init: function(currentUrl) {
		...
		service.getExternal('/session/current_user', function(user){
			...
			service.getExternal('/admin/koda/koda-types/_builtin_registration.json', function(builtin){

                service.getExternal('/admin/koda/koda-types/type_registration.json', function(custom){
